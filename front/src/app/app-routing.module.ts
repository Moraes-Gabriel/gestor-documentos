...
const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  {
    ...
    children: [{ path: 'documentos', component: DocumentosComponent,
    children: [
      {path:"meus", component: TabelaDocumentosComponent},
      {path:"indice", component: TabelaDocumentosComponent},
      {path:"indice/admin", component: IndiceDocumentosTabelaComponent},
  ...
  },
  {
    ...
    children: [{ path: 'admin', component: ConcessaoComponent,
      children: [
  ...
  { path: 'home', redirectTo: 'user/login'}
